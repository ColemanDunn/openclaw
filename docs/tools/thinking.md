...
- For `xai/*`, Fast requests `service_tier=priority` on public xAI and Grok OAuth text endpoints. Legacy aliases retain their fast-model rewrites. See [xAI fast mode](/providers/xai#fast-mode).
